...
public class ScriptCommandAddFarFogModifier extends StagedScriptCommand{
	...
	public void perform() throws Exception {
		this.pack.locIterator(BiomeLookup.fromForge()).forEachRemaining(loc -> BiomeModificationManager.forBiome(loc).getFog().addFarModifier(this.minY, this.maxY, this.modifier));
	}
