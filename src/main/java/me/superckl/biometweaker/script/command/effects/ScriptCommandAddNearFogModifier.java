...
@AutoRegister(classes = {BiomesScriptObject.class, TweakerScriptObject.class}, name = "addNearFogModifier")
@AllArgsConstructor
public class ScriptCommandAddNearFogModifier extends StagedScriptCommand{

	private final BiomePackage pack;
	private final float modifier;
	private final int minY, maxY;

	public ScriptCommandAddNearFogModifier(final BiomePackage pack, final float modifier) {
		this.pack = pack;
