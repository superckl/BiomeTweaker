...
public class ScriptCommandAddRemoveBiomeFlower extends ScriptCommand{
	...
	public ScriptCommandAddRemoveBiomeFlower(final BiomePackage pack, final BlockStateBuilder<?> block) {
	...
	public ScriptCommandAddRemoveBiomeFlower(final BiomePackage pack, final BlockStateBuilder<?> block, final int weight) {
